...
from app.api.routes import connections, dashboard, goals, health, savings_goals, transactions, tree, users
...
async def lifespan(app: FastAPI):
    # Recreate tables on startup (drop + create for early development)
...
app.include_router(
    savings_goals.router, prefix="/api/savings-goals", tags=["savings-goals"]
)
app.include_router(
